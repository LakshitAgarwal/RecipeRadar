...
const Footer = () => {
  return (
    <div className="bg-black text-white min-h-[50vh] mt-26 px-10 py-10">
      {/* Logo & Branding */}
      <div className="flex items-center justify-center text-center">
        <img src={logo} alt="Recipe Radar Logo" className="h-16 w-auto" />
        <h1 className="text-3xl font-semibold text-yellow-300 mt-2">
          Recipe Radar
        </h1>
      </div>

      {/* Footer Content */}
      <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center pt-6">
        {/* Explore Section */}
        ...
        {/* Recipes Section */}
        <div className="border-l border-gray-700 pl-6 flex flex-col items-center">
